...
namespace NgimuApi
{
	public sealed partial class Settings : SettingCategrory
	{
		...
		/// <summary>
		/// Gets USB/External Current Limit setting.
		/// </summary>
		public ISettingValue<bool> UsbExternalCurrentLimit { get; private set; }
	    ...
	    public Settings()
	    {
			...
			SendRateSensors = new SettingValue_Float(SendRates, "Sensors", "Sensors Send Rate", LookupDocumentation("/rate/sensors"), "/rate/sensors", false, false);
			SendRateMagnitudes = new SettingValue_Float(SendRates, "Magnitudes", "Magnitudes Send Rate", LookupDocumentation("/rate/magnitudes"), "/rate/magnitudes", false, false);
			SendRateQuaternion = new SettingValue_Float(SendRates, "Quaternion", "Quaternion Send Rate", LookupDocumentation("/rate/quaternion"), "/rate/quaternion", false, false);
			SendRateRotationMatrix = new SettingValue_Float(SendRates, "Rotation Matrix", "Rotation Matrix Send Rate", LookupDocumentation("/rate/matrix"), "/rate/matrix", false, false);
			SendRateEulerAngles = new SettingValue_Float(SendRates, "Euler Angles", "Euler Angles Send Rate", LookupDocumentation("/rate/euler"), "/rate/euler", false, false);
			SendRateLinearAcceleration = new SettingValue_Float(SendRates, "Linear Acceleration", "Linear Acceleration Send Rate", LookupDocumentation("/rate/linear"), "/rate/linear", false, false);
			SendRateEarthAcceleration = new SettingValue_Float(SendRates, "Earth Acceleration", "Earth Acceleration Send Rate", LookupDocumentation("/rate/earth"), "/rate/earth", false, false);
			SendRateAltitude = new SettingValue_Float(SendRates, "Altitude", "Altitude Send Rate", LookupDocumentation("/rate/altitude"), "/rate/altitude", false, false);
			SendRateTemperature = new SettingValue_Float(SendRates, "Temperature", "Temperature Send Rate", LookupDocumentation("/rate/temperature"), "/rate/temperature", false, false);
			SendRateHumidity = new SettingValue_Float(SendRates, "Humidity", "Humidity Send Rate", LookupDocumentation("/rate/humidity"), "/rate/humidity", false, false);
			SendRateBattery = new SettingValue_Float(SendRates, "Battery", "Battery Send Rate", LookupDocumentation("/rate/battery"), "/rate/battery", false, false);
			SendRateAnalogueInputs = new SettingValue_Float(SendRates, "Analogue Inputs", "Analogue Inputs Send Rate", LookupDocumentation("/rate/analogue"), "/rate/analogue", false, false);
			SendRateRssi = new SettingValue_Float(SendRates, "RSSI", "RSSI Send Rate", LookupDocumentation("/rate/rssi"), "/rate/rssi", false, false);
			...
			AuxSerialBufferSize = new SettingValue_UInt32(AuxiliarySerial.SendCondition, "Buffer Size", "Auxiliary Serial Send Buffer Size", LookupDocumentation("/auxserial/buffer"), "/auxserial/buffer", false, false);
